...
var hashPassword = function (password) {
    var salt = parseInt(process.env.salt, 10);
    return bcrypt_1.default.hashSync("".concat(password).concat(process.env.pepper), salt);
};
var UserModel = /** @class */ (function () {
    function UserModel() {
    }
    UserModel.prototype.deleteProduct = function (arg0) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        sql = "INSERT INTO users (email, user_name, first_name, last_name, password) \n                  values ($1, $2, $3, $4, $5) \n                  RETURNING id, email, user_name, first_name, last_name";
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Could not find user ".concat(id, ", ").concat(error_3.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("Could not update user: ".concat(u.user_name, ", ").concat(error_4.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        throw new Error("Could not delete user ".concat(id, ", ").concat(error_5.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserModel.prototype.authenticate = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, result, hashPassword_1, isPasswordValid, userInfo, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 2:
                        ...
                        isPasswordValid = bcrypt_1.default.compareSync("".concat(password).concat(process.env.pepper), hashPassword_1);
